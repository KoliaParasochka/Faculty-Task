...
namespace Faculty.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            WriteToInfo("== User: " + User.Identity.Name + " Go to personal area, action Index, ManageController");
        ...
        {
            WriteToInfo("== User: " + User.Identity.Name + " action NoAccess, ManageController");
            return View();
        }

        /// <summary>
        /// This action show a personal area
        /// of teacher
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// This action takes ctudents from 
        /// course and show it on the view.
        /// </summary>
