...
namespace Faculty.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Message = "";
            if(returnUrl != "/Home/Registration")
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            else
            {
                ...
                WriteToInfo("-- User: " + model.Email + " was logined - action login, AccountController");
        ...
        public async Task<ActionResult> Register(RegisterAccount model)
        {
            ...
            WriteToInfo("-- User: " + model.Email + " was registrated - action register, AccountController");
